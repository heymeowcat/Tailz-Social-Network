    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (!fp.equals("undefined")) {
                DB.iud("INSERT INTO `post` ( `post_heading`, `post_img_area`, `post_detial`, `post_time`, `users_idusers`, `post_type_idpost_type`,Post_Privacy) VALUES ( '" + ENCDEC.encrypt(title, new KEY().secretKey) + "', '" + ENCDEC.encrypt(fp, new KEY().secretKey) + "','" + ENCDEC.encrypt(description, new KEY().secretKey) + "', CURRENT_TIMESTAMP, '" + uid + "', '1','"+privacy+"');");
            }
