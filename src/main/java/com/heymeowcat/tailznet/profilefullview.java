        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            while (rs.next()) {
                if (rs.getString(7).equals("1")) {
                    ...
                    out.write("<img class='responsive-img' src='" + rs.getString(3) + "'>");
                    out.write("</div>");
                    out.write("<div class='card-content'>");
                    out.write("<span class='card-title " + Dcolor + "'><b class='truncate " + Dcolor + "'>" + rs.getString(2) + "</b><i class='material-icons right activator waves-effect  " + Dcolor + "'>more_vert</i></span>");
                    out.write("<p class='truncate'>" + rs.getString(4) + "</p>");
                    out.write("</div>");
                    out.write("<div class='" + Acolor + " " + Dcolor + "  card-reveal'>");
                    out.write("<span class='card-title " + Dcolor + " text-darken-4 truncate'>" + rs.getString(2) + "<i class='material-icons right waves-effect'>close</i></span>");
                    out.write("<div class='card-content'>");
                    out.write("<a>");
                    ...
                    out.write("<span class='card-title " + Dcolor + " text-darken-4 truncate'>" + rs.getString(2) + "</span>");
                    out.write("<div class='card-content'>");
                    out.write("<div  class='" + Bcolor + " " + Dcolor + " chip waves-effect waves-light'>");
